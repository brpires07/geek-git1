# Nome do seu projeto
> Um resumo curto sobre o que o seu projeto faz (1 ou 2 linhas)
...
Alguns exemplos que motivariam as pessoas a utilizarem o projeto ou que demonstrassem que este é útil para alguma coisa. Divida esta parte em partes menores e se possível coloque algum código ou prints de telas.
...
* 0.2.0
    * CHANCE: Removida a função `setPadraoXYZ()`
